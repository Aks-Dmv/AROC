...
#SBATCH --chdir=../
PYTHONPATH='.' python3.7 start_scripts/ocpg.py --env FourRooms-v0 --workers 8 --save-model-dir saved/ocpgDisFRmssave/ --log-dir saved/ocpgDisFRmssave/ --options 7 --delib 0.1 --num-steps 50
