...
class SharedAdam3(optim.Optimizer): #to correct python3 related issue with item for mini-grid
    """Implements Adam algorithm with shared states.
    """
    ...
    def __init__(self,
        ...
        defaults = defaultdict(
            ...
            weight_decay=weight_decay,
            amsgrad=amsgrad)
        super(SharedAdam3, self).__init__(params, defaults)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                p.data.addcdiv_(-step_size[0], exp_avg, denom)
